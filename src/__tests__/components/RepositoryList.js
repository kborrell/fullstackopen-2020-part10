...
describe('RepositoryList', () => {
  describe('RepositoryListContainer', () => {
    it('renders repository information correctly', () => {
      ...
      var fullNames = getAllByTestId('repoFullName');
      var descriptions = getAllByTestId('repoDescription');
      var languages = getAllByTestId('repoLanguage');
      var stargazers = getAllByTestId('repoStargazersCount');
      var forks = getAllByTestId('repoForksCount');
      var reviews = getAllByTestId('repoReviewsCount');
      var ratings = getAllByTestId('repoRatingAvg');
      ...
      expect(stargazers).toHaveLength(2);
